...
public class DeleteContentWrapper {
    
    public DeleteContentWrapper() {}

    public void runDeleteContent(Integer dc_c,
                                 Integer dc_u1,
                                 Integer dc_u2,
                                 Integer dc_i,
                                 machine3 m) {
        delete_content delete_content = new delete_content(m);
        if(delete_content.guard_delete_content(dc_c,dc_u1,dc_u2,dc_i)) {
            ...
            delete_content.run_delete_content(dc_c, dc_u1, dc_u2, dc_i);
            m.set_chatcontent(
    ...
    protected BRelation<Integer,BRelation<Integer,BRelation<Integer,Integer>>> 
        ...
        BRelation<Integer, BRelation<Integer, Integer>> content_new = 
                new BRelation<Integer, BRelation<Integer, Integer>>();
        BRelation<Integer, BRelation<Integer, Integer>> content_old =
                chatcontent_tmp.elementImage(u2).iterator().next();
